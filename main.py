...
def main():
    ...
    for step in tqdm(range(max_cycles), total=max_cycles):
        actions = {env.agents[0]: dqn_policy(observations[env.agents[0]]),
                   env.agents[1]: random_policy(observations[env.agents[1]], env.agents[1])}
